...
class Bravia {
  ...
  apiCall(url, method, version, params, req) {  
    ...
    return new Promise((resolve, reject) => {
      if(bravia_url||bravia_header['X-Auth-PSK']){
        axios({
          url: bravia_url + url,
          method: req,
          data: data,
        ...
        reject('No IP / PSK found in config!');
      }
    });
  }
  ...
  setAudioVolume(target, volume) {
    ...
    return this.apiCall('/sony/audio', 'setAudioVolume', '1.0', {target: target, volume: volume});
  }
